...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/cloudflare-flat-bird)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/cloudflare-flat-bird
```

A live public deployment of this template is available at [https://cloudflare-flat-bird.templates.workers.dev](https://cloudflare-flat-bird.templates.workers.dev)
